...
export const MEGA_MENUS: MegaMenuSection[] = [
  ...
  },
  {
    ...
    label: "Archiefkasten",
    href: SHOP_PATH,
    eyebrow: "Opslag en archief",
    title: "Kantoorkasten en archief",
    description:
  ...
  },
  {
    ...
    href: SHOP_PATH,
    eyebrow: "Organisatie",
    title: "Ladenkasten en rolblokken",
    description:
  ...
  },
  {
    ...
    href: SHOP_PATH,
    eyebrow: "Vergaderen",
    title: "Kantoor en vergadertafels",
    description:
  ...
  },
  {
    ...
    items: [
      { label: "Bureaustoelen en stoelen", img: "https://officeimage.nl/wp-content/uploads/2024/10/Bureaustoel-Technox-1.png" },
    ...
    extras: [
      ...
      { label: "Werkstoelen en krukken" },
      { label: "Garderobekasten" },
      { label: "Helmkasten" },
      { label: "Minilockers" },
      { label: "Postvakkenkasten" },
      { label: "Transparante lockers" },
      { label: "Zadelkasten" },
      { label: "Zitbanken" },
